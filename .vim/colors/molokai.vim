...
if &t_Co > 255
   ...
   " MiniBufExpl Colors
   hi MBEVisibleActiveNormal ctermfg=70 ctermbg=233
   hi MBEVisibleActiveChanged ctermfg=214 ctermbg=233
   hi MBEVisibleChanged ctermfg=210
   hi MBEVisibleNormal ctermfg=245
   hi MBEChanged ctermfg=124
   hi MBENormal ctermfg=245
